  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div className="flex-1 items-start gap-0 space-y-0">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Youssef</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
          <span className={`${styles.heroSubText} text-[#9e4d9e]`}>Software Engineer</span>

          </p>
          <p className="text-xl font-bold mb-10">
          <br className='sm:block hidden'/>MERN Stack | NextJS | React-Native | ViteJS | Web3 <br className='sm:block hidden' /> 
          </p>
        </div>
      </div>

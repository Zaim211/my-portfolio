    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          ...
          <span className={`${styles.heroSubText} text-[#9e4d9e]`}>Software Engineering | Back-end</span>
          {/* <br className='sm:block hidden' /> I develop 3D visuals, user <br className='sm:block hidden' />
